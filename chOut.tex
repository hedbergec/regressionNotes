...
\begin{equation}
D_i = \frac{\left(e^{\left(standardized\right)}_i\right)^2}{k+1}\times\frac{h_i}{1-h_i}
\end{equation}
...
\begin{equation}
D_i = e^{\left(studentized\right)}_i\times \sqrt{\frac{h_i}{1-h_i}}
\end{equation}
...
For detailed treatment of outlier detection and diagnostics, see \citep{fox} and \citep{hill}. For regression analysis including influence diagnostics, consult \citep{agresti}.
