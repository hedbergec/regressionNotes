...
\chapter{Logistic regression}\citep{glm}
\label{sec:logit}
...
\begin{equation}
L\left(p_i \vert y_1 \ldots y_N\right)=\prod_{i=1}^N e^{y_i\left(\beta_0+\beta_1x_i\right)}\left(1+e^{\beta_0+\beta_1x_i}\right)^{-1}
\end{equation}
and the log likelihood is
\begin{equation}
\mbox{ln}\left(L\left(p_i \vert y_1 \ldots y_N\right)\right)=\sum_{i=1}^N \left[y_i\left(\beta_0+\beta_1x_i\right)-\mbox{ln}\left(1+e^{\beta_0+\beta_1x_i}\right)\right]
\end{equation}
...
\begin{equation}
\frac{\partial\mbox{ln}\left(L\left(p_i \vert y_1 \ldots y_N\right)\right)}{\partial\beta_0}=\sum_{i=1}^N\left(y_i-\frac{e^{\beta_0+\beta_1x_i}}{1+e^{\beta_0+\beta_1x_i}}\right)
\end{equation}
set to zero and
\begin{equation}
...
\begin{equation}
\frac{\partial\mbox{ln}\left(L\left(p_i \vert y_1 \ldots y_N\right)\right)}{\partial\beta_1}=\sum_{i=1}^N\left(x_iy_i-\frac{x_i}{1+e^{-\left(\beta_0+\beta_1x_i\right)}}\right)
\end{equation}
set to zero and
\begin{equation}
\sum_{i=1}^Nx_iy_i=\sum_{i=1}^N\frac{x_i}{1+e^{-\left(\beta_0+\beta_1x_i\right)}}
\end{equation}
...
For logistic regression and generalized linear models, see \citep{glm}, \citep{fox}, and \citep{agresti}. For maximum likelihood estimation, consult \citep{eliason1993maximum}. For power analysis in GLMs, see \citep{vaeth2004simple} and \citep{lyles2007practical}.
