...
{\bf b = \left(X'X\right)^{-1}X'y} =
\begin{bmatrix}
\left(\frac{70}{24}\times14\right)+\left(\frac{-16}{24}\times60\right) \\
\left(\frac{-16}{24}\times14\right)+\left(\frac{4}{24}\times60\right) \\
\end{bmatrix}
\]
...
\begin{equation}
\mbox{ln}\left(L\left({\bf b, V \vert \bf y}\right)\right)=-\frac{N}{2}\mbox{ln}\left(2\pi\right)-\frac{1}{2}\mbox{ln}\left(\det{\bf V}\right)-\frac{1}{2}{\bf \left(y-Xb\right)'V^{-1}\left(y-Xb\right)}
\end{equation}
...
For treatment of categorical predictors, contrast coding, and analysis of variance, see \citep{fox} and \citep{agresti}. For discussion of ANOVA as a special case of regression, consult \citep{cameron2005microeconometrics}. Additional perspectives on designing orthogonal contrasts can be found in \citep{kish1965survey}.
