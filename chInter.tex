...
\]
\[
\left(\hat{y}|x=1,z=0\right)=\beta_0+\beta_1=0.449+-1.425=-0.976
\]
\[
...
\]
which has a two-sided probability, or $p$-value, of about 0.156, which is greater than the threshold of $\alpha = 0.05$. Thus, the effect is not significant.
\begin{table}[htbp]\centering
...
For comprehensive treatment of interaction effects in regression models, see \citep{fox} and \citep{hill}. For discussion of centering strategies and interpretation of interactions with continuous variables, consult \citep{cohen1988statistical}. Additional perspectives on modeling conditional effects in social science applications can be found in \citep{agresti}.
