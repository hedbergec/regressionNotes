...
\end{equation}
Which leads to Bayes' rule \citep{rice2007mathematical}. If we have the same circumstances, then we can actually find the probability of an event $B_j$ in the other way
...
For an excellent treatment of probability theory and mathematical foundations, see \citep{rice2007mathematical} and \citep{gill2006essential}. For understanding how probability concepts apply to research design and experimentation, consult \citep{fisher1973statistical}.
