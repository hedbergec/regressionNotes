...
For comprehensive treatment of probability distributions, see \citep{rice2007mathematical} and \citep{agresti}. Essential mathematical foundations can be found in \citep{gill2006essential}.\subsection{The normal distribution}
...
\begin{figure}
   ...
   \caption{A variable $x$ distributed $x \sim N\left(0,1\right)$.}
  \label{fig:normal}
\end{figure}
